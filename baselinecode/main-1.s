...
# main.c:67:                 C_temp[u] = C[i][j+u];
	...
	cltq
	leaq	0(,%rax,8), %rdx	#, _2
	movq	-72(%rbp), %rax	# C, tmp121
	addq	%rdx, %rax	# _2, _3
	movq	(%rax), %rax	# *_3, _4
# main.c:67:                 C_temp[u] = C[i][j+u];
	movl	-36(%rbp), %ecx	# j, tmp122
	movl	-32(%rbp), %edx	# u, tmp123
...
# main.c:67:                 C_temp[u] = C[i][j+u];
	movl	-32(%rbp), %eax	# u, tmp125
	cltq
	vmovsd	%xmm0, -16(%rbp,%rax,8)	# _9, C_temp[u_41]
# main.c:66: 	    for (int u=0; u<UNROLL; u++){
	addl	$1, -32(%rbp)	#, u
.L19:
# main.c:66: 	    for (int u=0; u<UNROLL; u++){
...
# main.c:72:                     C_temp[u] += A[i][k] * B[k][j+u];
	movl	-28(%rbp), %eax	# u, tmp127
	cltq
	vmovsd	-16(%rbp,%rax,8), %xmm1	# C_temp[u_42], _10
# main.c:72:                     C_temp[u] += A[i][k] * B[k][j+u];
	movl	-40(%rbp), %eax	# i, tmp128
	cltq
	leaq	0(,%rax,8), %rdx	#, _12
	movq	-56(%rbp), %rax	# A, tmp129
	addq	%rdx, %rax	# _12, _13
	movq	(%rax), %rax	# *_13, _14
# main.c:72:                     C_temp[u] += A[i][k] * B[k][j+u];
	movl	-24(%rbp), %edx	# k, tmp130
	movslq	%edx, %rdx	# tmp130, _15
	salq	$3, %rdx	#, _16
	addq	%rdx, %rax	# _16, _17
	vmovsd	(%rax), %xmm2	# *_17, _18
# main.c:72:                     C_temp[u] += A[i][k] * B[k][j+u];
	movl	-24(%rbp), %eax	# k, tmp131
	cltq
...
# main.c:72:                     C_temp[u] += A[i][k] * B[k][j+u];
	movl	-36(%rbp), %ecx	# j, tmp133
	movl	-28(%rbp), %edx	# u, tmp134
...
# main.c:72:                     C_temp[u] += A[i][k] * B[k][j+u];
	...
	movl	-28(%rbp), %eax	# u, tmp136
	cltq
	vmovsd	%xmm0, -16(%rbp,%rax,8)	# _29, C_temp[u_42]
# main.c:71:             	for(int k=0; k<M; k++){
	addl	$1, -24(%rbp)	#, k
.L22:
# main.c:71:             	for(int k=0; k<M; k++){
	movl	-24(%rbp), %eax	# k, tmp137
	cmpl	-80(%rbp), %eax	# M, tmp137
	jl	.L23	#,
# main.c:69: 	    for (int u=0; u<UNROLL; u++){
	addl	$1, -28(%rbp)	#, u
.L21:
...
# main.c:76: 	        C[i][j+u] = C_temp[u];
	movl	-40(%rbp), %eax	# i, tmp138
	cltq
	leaq	0(,%rax,8), %rdx	#, _31
	movq	-72(%rbp), %rax	# C, tmp139
	addq	%rdx, %rax	# _31, _32
	movq	(%rax), %rax	# *_32, _33
# main.c:76: 	        C[i][j+u] = C_temp[u];
	movl	-36(%rbp), %ecx	# j, tmp140
	movl	-20(%rbp), %edx	# u, tmp141
...
# main.c:76: 	        C[i][j+u] = C_temp[u];
	movl	-20(%rbp), %eax	# u, tmp143
	cltq
	vmovsd	-16(%rbp,%rax,8), %xmm0	# C_temp[u_44], _38
# main.c:76: 	        C[i][j+u] = C_temp[u];
...
.L18:
# main.c:64:         for(int j=0; j<N; j+=UNROLL) {
	movl	-36(%rbp), %eax	# j, tmp144
	cmpl	-84(%rbp), %eax	# N, tmp144
	jl	.L27	#,
# main.c:62:     for(int i=0; i<L; i++) {
	addl	$1, -40(%rbp)	#, i
.L17:
# main.c:62:     for(int i=0; i<L; i++) {
	movl	-40(%rbp), %eax	# i, tmp145
	cmpl	-76(%rbp), %eax	# L, tmp145
	jl	.L28	#,
# main.c:80: }
	nop	
